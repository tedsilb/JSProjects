...
const includesAll = (masterArray: string[], itemsToCheck: string[]): boolean => {
...
const arraysEqual = (arrayA: string[], arrayB: string[]): boolean => {
	const a = [...arrayA].sort();
	const b = [...arrayB].sort();
...
const main = () => {
	const btnResetGame: HTMLElement = getEl("reset-button");
	const lblStatusDisplay: HTMLElement = getEl("status-display");
	const cellA1: HTMLElement = getEl("A1");
	const cellA2: HTMLElement = getEl("A2");
	const cellA3: HTMLElement = getEl("A3");
	const cellB1: HTMLElement = getEl("B1");
	const cellB2: HTMLElement = getEl("B2");
	const cellB3: HTMLElement = getEl("B3");
	const cellC1: HTMLElement = getEl("C1");
	const cellC2: HTMLElement = getEl("C2");
	const cellC3: HTMLElement = getEl("C3");
	let cpuChoice: string;
	let cpuStarted: boolean;
	let buttonsEnabled: boolean;
	let availableCells: string[] = [];
	let userChosenCells: string[] = [];
	let cpuChosenCells: string[] = [];
	...
	const hasWon = (chosenCells: string[]): boolean => {
		return (
	...
	const buttonPress = (button: HTMLElement, gridLoc: string) => {
