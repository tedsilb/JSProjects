...
const initialiseDomVariables =
    () => {
      ...
      targetNumberInput =
          <HTMLInputElement>document.getElementById('targetNumber');
      saveTargetNumberButton =
          document.getElementById('saveTargetNumberButton');
      ...
      guessNumberInput =
          <HTMLInputElement>document.getElementById('guessNumber');
